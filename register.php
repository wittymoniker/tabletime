...
and ((x number of votes * % voteban from neutral)^2 +1)*time = moksha from being votebanned. </i> <br><br>
	...
	We have <a href = https://github.com/wittymoniker/tabletime>software</a> <a href = tabletime.zip>(DIRECT))</a> for admin <br>and Dedicated Host as well as user peer hosting software. <br>They are deployable server programs which merge with <br>eachother in a network to expediate requests.<br>
